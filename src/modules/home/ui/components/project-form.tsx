...
export function ProjectForm() {
  ...
  const createProject = useMutation({
    mutationFn: trpc.projects.create.mutate,
    onSuccess: (data) => {
    ...
    <section className="space-y-6">
      <Form {...form}>
        <form
          ...
          className={cn(
            "relative border p-4 pt-1 rounded-2xl bg-sidebar dark:bg-sidebar transition-all",
            isFocused && "shadow-sm"
          )}
        >
          <FormField
      ...
      <div className="flex flex-wrap justify-center gap-2 hidden md:flex max-w-3xl mx-auto">
